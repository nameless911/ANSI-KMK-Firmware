...
HHK.keymap = [
    [
        KC.ESC, KC.N1,  KC.N2,          KC.N3,  KC.N4,  KC.N5,  KC.N6,  KC.N7,  KC.N8,  KC.N9,  KC.N0,  KC.MINS,KC.EQL, KC.BSLS,KC.BKSP,  
        KC.TAB, KC.Q,   KC.W,           KC.E,   KC.R,   KC.T,   KC.Y,   KC.U,   KC.I,   KC.O,   KC.P,   KC.LBRC,KC.RBRC,KC.BSLS,KC.N2,  
        KC.CAPS,KC.A,   KC.S,           KC.D,   KC.F,   KC.G,   KC.H,   KC.J,   KC.K,   KC.L,   KC.SCLN,KC.QUOT,KC.N1,  KC.ENT, KC.N3,  
        KC.LSFT,KC.Z,   KC.X,           KC.C,   KC.V,   KC.B,   KC.N,   KC.M,   KC.COMM,KC.DOT, KC.SLSH,KC.RSFT,KC.RSFT,KC.N3,  KC.MO(1),  
        KC.LCTL,KC.LWIN,KC.LM(2,KC.LALT),KC.C,   KC.PPLS,KC.SPC, KC.LWIN,KC.LALT,KC.LCTL,KC.PPLS,KC.MO(1),KC.LEFT,KC.UP,  KC.DOWN,KC.RIGHT,  
    ],
        [
        ...
        KC.CAPS,KC.VOLU,KC.VOLD,        KC.MUTE,KC.EJCT,KC.G,   KC.PAST,KC.PSLS,KC.HOME,KC.PGUP,KC.LEFT,KC.RGHT,KC.N1,  KC.ENT, KC.N3,  
    ...
    [
        KC.ZKHK,KC.N1,  KC.N2,          KC.N3,  KC.N4,  KC.N5,  KC.N6,  KC.N7,  KC.N8,  KC.N9,  KC.N0,  KC.MINS,KC.EQL, KC.BSLS,KC.BKSP,  
        KC.TAB, KC.Q,   KC.W,           KC.E,   KC.R,   KC.T,   KC.Y,   KC.U,   KC.I,   KC.O,   KC.P,   KC.LBRC,KC.RBRC,KC.BSLS,KC.N2,  
        KC.CAPS,KC.A,   KC.S,           KC.D,   KC.F,   KC.G,   KC.H,   KC.J,   KC.K,   KC.L,   KC.SCLN,KC.QUOT,KC.N1,  KC.ENT, KC.N3,  
        KC.LSFT,KC.Z,   KC.X,           KC.C,   KC.V,   KC.B,   KC.N,   KC.M,   KC.COMM,KC.DOT, KC.SLSH,KC.RSFT,KC.RSFT,KC.N3,  KC.MO(1),  
